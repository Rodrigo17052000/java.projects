...
public class Principal1 { // Classe Principal1 uqe contém o método main
	
	public static void main(String[] args) {
		
		Animal meuAnimal = new Animal(); // Cria um objeto Animal
		Animal meuPorco = new Porco(); // Cria um objeto Porco
		Animal meuCao = new Cao(); // Cria um objeto Cao
		...
		meuCao.somAnimal(); // Chama o método somAnimal para o objeto Cao
	}
